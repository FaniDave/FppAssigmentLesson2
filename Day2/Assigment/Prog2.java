...
public class Prog2 {
    ...
    public static void main(String[] args) {
        ...
        // Implement the code
        //Splitting the string using a delimiter ":" to create an array of string separated by ":"
        ...
        for (String str : str1Arr) {
            ...
            System.out.println(str2Arr[0]);          //Printing the first element of the array which is the productId
        }
    }
}
